<template>
    ...
    <AddForgeDialog v-model:visible="state.addMissionVisible" fileType="文本" @initialData="addDetect" @success="updateProbability"
...
const searchOpt = [
    {
        ...
        options: [{ label: '视频', value: '视频' }, { label: '图片', value: '图片' }, { label: '音频', value: '音频' }, { label: '文本', value: '文本' }]
    },
]
...
const getList = async() => {
    try {
        const response = await axios.get('http://49.123.117.252:3091/ai_text'); // 请求后端接口
        // 映射uuid到id
