...
app.get('/text', (req, res) => {
    const query = `SELECT * FROM text_img ORDER BY id DESC`;
...
app.delete('/text/:id', async (req, res) => {
    ...
    const query1 = `SELECT fileUrl,pdf_path from text_img where uuid = ?`;
...
// 监听端口
app.listen(port, () => {
    console.log(`get_text_db running on port ${port}`);
});
