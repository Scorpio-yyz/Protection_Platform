<template>
    <div class="forge-container">
        ...
        <el-row justify="end">
            <el-button type="primary" @click="state.addMissionVisible = true">新增修复</el-button>
        </el-row>
    ...
    <AddForgeDialog v-model:visible="state.addMissionVisible" fileType="待修复图片" @initialData="addDetect" @success="updateProbability"
...
const getList = async() => {
    try {
        const response = await axios.get('http://49.123.117.252:9092/inpainting_mask_img'); // 请求后端接口
        // 映射uuid到id
